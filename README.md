...
| [ai-coding-workflow](skills/ai-coding-workflow/SKILL.md) | 统一 AI Coding 工作流：以 Phase 0~10 / 5B 为主线，集成 spec-kit、gstack、context7、gitleaks、OMC 等阶段能力，并补充 Claude Code / Codex / Gemini / CC Switch 安装指引 |
